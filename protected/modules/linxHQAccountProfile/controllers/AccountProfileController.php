...
class AccountProfileController extends Controller
{
	...
	{
		$model=new LinxHQAccountProfile;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['LinxHQAccountProfile']))
		{
			$model->attributes=$_POST['LinxHQAccountProfile'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('LinxHQAccountProfile');
	...
	{
		$model=new LinxHQAccountProfile('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['LinxHQAccountProfile']))
			$model->attributes=$_GET['LinxHQAccountProfile'];
	...
	{
		$model=LinxHQAccountProfile::model()->findByPk($id);
		if($model===null)

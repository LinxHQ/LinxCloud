...
class AccountController extends LinxHQController
{
	/**
	...
	public function actionCreate()
	{
		...
		$model=new LinxHQAccount;
                $sysApplication = new LinxHQSysApplication();
		//$accountSubscriptionModel = new LinxHQAccountSubscription();
		$accountProfile = new LinxHQAccountProfile();
                
                // populate data if form is being submitted
                /**
                $active_subscription_package_names = array(''=>'Select package');
                if (isset($_POST['LinxHQAccountSubscription'])
                        && isset($_POST['LinxHQAccountSubscription']['application_id']))
                {
                    $accountSubscriptionModel->attributes = $_POST['LinxHQAccountSubscription'];
                    
                    // load subscription for this application, if none selected
                    if ($_POST['LinxHQAccountSubscription']['account_subscription_package_id'] == null)
                    {
                        $active_subscription_packages = LinxHQSubscriptionPackage::getActivePackages($accountSubscriptionModel->application_id);
		 ...
		 */
		if(isset($_POST['LinxHQAccount']))
		{
			$model->attributes=$_POST['LinxHQAccount'];
			$model->account_id = null;
                        $accountProfile->attributes = $_POST['LinxHQAccountProfile'];

                        $model->accountProfile = $accountProfile;
                        //$model->accountSubscription = $accountSubscriptionModel;
		...
		LinxHQApplication::render($this, 'create', $data);
	}
	...
	{
		$model=new LinxHQAccount('search');
	...
	{
		$model=LinxHQAccount::model()->findByPk($id);

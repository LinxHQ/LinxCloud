 ...
 */
class LinxHQAccountPasswordReset extends LinxHQCActiveModel
{
	 ...
	 * @return LinxHQAccountPasswordReset the static model class
	 */
	...
	{
		return 'sys_account_password_reset';
	}
	...
	public function save($runValidation=true, $attributes=null)
	{
		...
		$account = LinxHQAccount::model()->getAccountByEmail($this->account_email);
		if ($account == null)
		{
	...
	public function findByRandomKey($email, $rand)
	{
		...
		if ($model && $model->account_password_reset_id > 0)
		{
			...
			$account = LinxHQAccount::model()->getAccountByEmail($email);

 ...
 * @property integer $account_invitation_entity_to_join
 * @property integer $account_invitation_type
 */
class LinxHQAccountInvitation extends LinxHQCActiveModel {

    public $account_invitation_message;
    public $account_invitation_entity_to_join;
     ...
     * @return LinxHQAccountInvitation the static model class
     */
    ...
    public function tableName() {
        return 'sys_account_invitations';
    }
    ...
    public function rules() {
        ...
        return array(
            array('account_invitation_master_id, application_id, account_invitation_to_email, account_invitation_date, account_invitation_status, account_invitation_rand_key, account_invitation_type', 'required'),
            array('account_invitation_master_id, account_invitation_status, account_invitation_entity_to_join, account_invitation_type', 'numerical', 'integerOnly' => true),
            array('account_invitation_to_email', 'length', 'max' => 255),
            array('account_invitation_rand_key', 'length', 'max' => 100),
            array('application_id, account_invitation_entity_to_join, account_invitation_message', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('account_invitation_id, account_invitation_master_id, account_invitation_to_email, account_invitation_date, account_invitation_status, account_invitation_rand_key', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'account_invitation_entity_to_join' => 'Entity to join',
            'account_invitation_type' => 'Type of Account',
        );
    }
    ...
    public function save($runValidation = true, $attributes = NULL) {
        ...
        if ($this->account_invitation_type === null) {
            $this->account_invitation_type = LinxHQAccountInvitation::ACCOUNT_INVITATION_TYPE_MEMBER;
        }
    ...
    public static function generateInvitationURL($id, $key) {
        $url = Yii::app()->createAbsoluteUrl('linxHQAccountTeamMember/accountInvitation/accept', array('id' => $id, 'key' => $key,));
        return $url;
    }
    ...
    public function getInvitesToAccount($account_id, $get_data = false) {
        $account = LinxHQAccount::model()->findByPk($account_id);

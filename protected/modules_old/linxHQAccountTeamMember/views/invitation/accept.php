...
/** @var model LinxHQAccountInvitation model */
/** $account */
...
<?php 
$application = LinxHQSysApplication::model()->findByPk($model->application_id);
if ($application)
{
    echo '<strong>Application: ' . $application->application_full_name . '</strong><br/>';
}
echo $form->passwordFieldRow($account, 'account_password', array('class'=>'span3')); ?>

 ...
 */
class LinxHQSubscriptionPackage extends LinxHQCActiveModel
{
	 ...
	 * @return LinxHQSubscriptionPackage the static model class
	 */
	...
	{
		return 'sys_subscription_packages';
	}
	...
	public function search()
	{
         ...
         * @return type
         */
	public static function getActivePackages($application_id) {
		$condition = 'subscription_package_status = :status_id AND application_id = :application_id';
		return LinxHQSubscriptionPackage::model()->findAll($condition, 
                        array(':status_id' => 1,

...
class AccountSubscriptionController extends Controller
{
	...
	{
		$model=new LinxHQAccountSubscription;
		...
		{
			$model->attributes=$_POST['LinxHQAccountSubscription'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('LinxHQAccountSubscription');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['LinxHQAccountSubscription']))
			$model->attributes=$_GET['LinxHQAccountSubscription'];
	...
	{
		$model=LinxHQAccountSubscription::model()->findByPk($id);
		if($model===null)
